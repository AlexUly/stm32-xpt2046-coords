...
int main(void)
{
  ...
  MX_UART4_Init();
  /* USER CODE BEGIN 2 */
  XPT2046_init(&hspi2, XPT2046_LANDSCAPE, 480, 320);
  char msg1[5];
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : TP_IRQ_Pin LCD_CS_Pin */
  GPIO_InitStruct.Pin = TP_IRQ_Pin|LCD_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
